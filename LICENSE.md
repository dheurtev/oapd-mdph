...
© David HEURTEVENT – 2026
Tous droits réservés.

## 1. Objet
La présente licence autorise l’utilisation gratuite du logiciel OAPD‑MDPH (ci‑après « le Logiciel »), dans les conditions définies ci‑dessous.

Le Logiciel est protégé par le droit d’auteur conformément au Code de la propriété intellectuelle.
...
L’utilisateur demeure seul responsable de l’usage qu’il fait du Logiciel.

## 6. Limitation de responsabilité
En aucun cas l’auteur ne pourra être tenu responsable :
- des décisions administratives prises sur la base des résultats générés,
- d’une mauvaise utilisation,
- d’une interprétation erronée,
- d’un préjudice direct ou indirect lié à son utilisation.

Cette limitation s’applique dans les limites autorisées par la loi française.
